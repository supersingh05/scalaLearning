object LearningScala3 {
  ...
  def upIt(x: String) : String = { return x.toUpperCase}
                                                  //> upIt: (x: String)String
  def upSome() : Unit = {println(upIt("blah")); println(upIt("moo"));}
                                                  //> upSome: ()Unit
  upSome()                                        //> BLAH
                                                  //| MOO
                                                  
  def upIt2(x: String, f: String => String) : String = {f(x)}
                                                  //> upIt2: (x: String, f: String => String)String
  println(upIt2("sdf", x => x.toUpperCase))       //> SDF
