object LearningScala1 {;import org.scalaide.worksheet.runtime.library.WorksheetSupport._; def main(args: Array[String])=$execute{;$skip(127); 
  ...
  val hello: String = "Holas!";System.out.println("""hello  : String = """ + $show(hello ));$skip(17); 
  ...
  val isBest: Boolean = picard == bestCaptain;System.out.println("""isBest  : Boolean = """ + $show(isBest ));$skip(292); 
 ...
 println(pi);$skip(23); 
 val doublePi = pi * 2;System.out.println("""doublePi  : Double = """ + $show(doublePi ));$skip(41); 
