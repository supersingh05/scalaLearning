object LearningScala1 {
  ...
  val hello: String = "Holas!"                    //> hello  : String = Holas!
  println(hello)                                  //> Holas!
  ...
  var helloThere: String = hello                  //> helloThere  : String = Holas!
  helloThere = hello + " There!"
  println(helloThere)                             //> Holas! There!
  ...
  val immutableHelloThere = hello + "There!"      //> immutableHelloThere  : String = Holas!There!
  println(immutableHelloThere)                    //> Holas!There!
 ...
 println(f" double of pi $doublePi%.3f")          //>  double of pi 6.283
